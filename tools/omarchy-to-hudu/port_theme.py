...
def render_readme(tokens, name, dark_src, light_src, light_pinned_300):
    ...
    lines = [
        ...
        "",
        f"Hudu skin generated from the {src} via [`tools/omarchy-to-hudu`](../../tools/omarchy-to-hudu/). Light + dark mode.",
        "",
    ...
    lines += [
        ...
        "## Source",
        "",
        f"- Generated by [`port_theme.py`](../../tools/omarchy-to-hudu/port_theme.py) from the omarchy `{dark_src}` theme"
...
def render(tokens, name, dark_src, light_src):
    ...
    header = (
        ...
        f"   Generated by tools/omarchy-to-hudu/port_theme.py\n"
