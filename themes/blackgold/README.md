...
Hudu skin generated from the omarchy `blackgold` palette (light half synthesized) via [`tools/omarchy-port`](../../tools/omarchy-port/). Light + dark mode.
...
- Generated by [`port_theme.py`](../../tools/omarchy-port/port_theme.py) from the omarchy `blackgold` theme (no light variant — light half synthesized)
