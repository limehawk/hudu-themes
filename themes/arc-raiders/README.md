...
Hudu skin generated from the omarchy `arc-raiders` palette (light half synthesized) via [`tools/omarchy-port`](../../tools/omarchy-port/). Light + dark mode.
...
- Generated by [`port_theme.py`](../../tools/omarchy-port/port_theme.py) from the omarchy `arc-raiders` theme (no light variant — light half synthesized)
