...
Hudu skin generated from the omarchy `harbordark` palette (light half synthesized) via [`tools/omarchy-to-hudu`](../../tools/omarchy-to-hudu/). Light + dark mode.
...
- Generated by [`port_theme.py`](../../tools/omarchy-to-hudu/port_theme.py) from the omarchy `harbordark` theme (no light variant — light half synthesized)
